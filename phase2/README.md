# Simple Doodle Jump — Phase 2

A C++ implementation of the classic *Doodle Jump* game, built with the SFML library. This phase extends the core gameplay with enemies, shooting, sound, and game settings.

## Key Features

- Multiple platform types: normal, moving, and breakable
- Spring-based jumping mechanics
- Enemy characters and shooting mechanics
...
| **UiManager** | Manages sprites and text elements for the menu, HUD, settings, and Game Over screen, as well as button interactions. |
